 ...
 *
 * Thus, if numColumns is 10, numRows is 5, and each closest image is 64x64, the resulting image
 * would be 640x320 pixels.
 *
 * @param clostest		A numColumns x numRows list of images in row-major order to be put into the resulting image.
